   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove: https://discord.gg/7p3WkS :scroll:
         :hearts: الموقع الرسمي للبوت https://discord.gg/7p3WkS website here  :hearts: **`)
...
**============ **
  ...
  ** -ite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 
